...
mmul = program.mmul
mmul.set_scalar_arg_dtypes([numpy.int32,numpy.int32, None, None, None, None, None])
...
for i in range(COUNT):    
    ...
    try:
        ...
        mmul(queue, (N,N), (locblocksize,locblocksize), N, locblocksize, d_a, d_b, d_c, A_block, B_block)
        
        #mmul(queue, (N,N), (localsize,localsize), numpy.int32 (N), d_a, d_b, d_c,d_Awrk, d_Bwrk)
        queue.finish()
    except Exception as e:
        print(f"=== Error for blocksize = {locblocksize} ===")
